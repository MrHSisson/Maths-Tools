...
const STANDALONE_BY_DESIGN = [
  ...
  "TeacherTools/MakeSubjectPreview",
  "TeacherTools/QuadraticFormulaPreview",
  "TeacherTools/RationaliseDenominatorPreview",
  "TeacherTools/SimplifySurdPreview",
  "TeacherTools/SkillLibrary",
  "TeacherTools/SolveFactorsPreview",
  "TeacherTools/SolveLinearEquationPreview",
  "TeacherTools/SolveLinearlyPreview",
  "TeacherTools/SubstituteBackPreview",
