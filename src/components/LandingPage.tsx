...
const categories = [
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'double-brackets', path: '/double-brackets', name: 'Double Brackets', icon: '(x+a)²', description: 'Expand pairs of brackets using grid or FOIL methods', ready: true },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'circles', path: '/circles', name: 'Properties of Circles', icon: '⭕', description: 'Learn and identify parts of a circle including radius, diameter, and circumference', ready: false },
    ]
  },
  {
