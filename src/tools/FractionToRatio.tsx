...
document.addEventListener("DOMContentLoaded",function(){
  ...
  function cw(c){return(PW-GAP*(c-1))/c;}
      function cell(inner,w,h,dc){return'<div class="'+(dc?"dc":"cell")+'" style="width:'+w+'mm;height:'+h+'mm;align-items:flex-start;padding-top:'+(PAD+4)+'mm;"><div class="q-inner">'+inner+'</div></div>';}
