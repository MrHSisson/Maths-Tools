...
// ===== QUESTION GENERATION - CONTINUED FROM PART 1 =====
  ...
  const generateCircumferenceQuestion = (level: string, angle: number): QuestionType => {
    if (level === 'level1') {
      ...
      return {
        ...
        working: [
          { type: 'step', text: `Diameter (d) = ${formatNumber(diameter)} cm` },
          { type: 'step', text: 'Circumference = πd' },
          { type: 'step', text: `Circumference = π × ${formatNumber(diameter)}` },
          { type: 'step', textPi: `Circumference = ${formatNumber(circumferencePi)}π cm`,
      ...
      return {
        ...
        angle, type: 'circumference',
        working: [
          { type: 'step', text: `Radius (r) = ${formatNumber(radius)} cm` },
          { type: 'step', text: 'Circumference = 2πr' },
          { type: 'step', text: `Circumference = 2 × π × ${formatNumber(radius)}` },
          { type: 'step', textPi: `Circumference = ${formatNumber(circumferencePi)}π cm`,
      ...
      const working: WorkingStep[] = findWhat === 'radius' ? [
        { type: 'step', text: `Circumference (C) = ${answerInPi ? `${formatNumber(circumferencePi)}π` : formatNumber(Math.round(circumference * 10) / 10)} cm` },
        { type: 'step', text: 'Circumference = 2πr' },
        { type: 'step', text: 'r = C ÷ (2π)' },
        { type: 'step', textPi: `r = ${formatNumber(circumferencePi)}π ÷ (2π)`,
          textNumeric: `r = ${formatNumber(Math.round(circumference * 10) / 10)} ÷ (2π)` },
        { type: 'step', textPi: `r = ${formatNumber(radius)} cm`,
        ...
        { type: 'step', text: `Circumference (C) = ${answerInPi ? `${formatNumber(circumferencePi)}π` : formatNumber(Math.round(circumference * 10) / 10)} cm` },
        { type: 'step', text: 'Circumference = πd' },
        { type: 'step', text: 'd = C ÷ π' },
        { type: 'step', textPi: `d = ${formatNumber(circumferencePi)}π ÷ π`,
          textNumeric: `d = ${formatNumber(Math.round(circumference * 10) / 10)} ÷ π` },
        { type: 'step', textPi: `d = ${formatNumber(diameter)} cm`,
  ...
  const generateAreaQuestion = (level: string, angle: number): QuestionType => {
    if (level === 'level1') {
      ...
      return {
        ...
        working: [
          { type: 'step', text: `Radius (r) = ${formatNumber(radius)} cm` },
          { type: 'step', text: 'Area = πr²' },
          { type: 'step', text: `Area = π × ${formatNumber(radius)}²` },
          { type: 'step', text: `Area = π × ${formatNumber(radius * radius)}` },
          { type: 'step', textPi: `Area = ${formatNumber(areaPi)}π cm²`,
      ...
      return {
        ...
        working: [
          { type: 'step', text: `Diameter (d) = ${formatNumber(diameter)} cm` },
          { type: 'step', text: `Radius (r) = d ÷ 2 = ${formatNumber(diameter)} ÷ 2 = ${formatNumber(radius)} cm` },
          { type: 'step', text: 'Area = πr²' },
          { type: 'step', text: `Area = π × ${formatNumber(radius)}²` },
          { type: 'step', text: `Area = π × ${formatNumber(radius * radius)}` },
          { type: 'step', textPi: `Area = ${formatNumber(areaPi)}π cm²`,
      ...
      const working: WorkingStep[] = findWhat === 'radius' ? [
        { type: 'step', text: `Area (A) = ${answerInPi ? `${formatNumber(areaPi)}π` : formatNumber(Math.round(area * 10) / 10)} cm²` },
        { type: 'step', text: 'Area = πr²' },
        { type: 'step', text: 'r² = A ÷ π' },
        { type: 'step', textPi: `r² = ${formatNumber(areaPi)}π ÷ π`,
          textNumeric: `r² = ${formatNumber(Math.round(area * 10) / 10)} ÷ π` },
        { type: 'step', textPi: `r² = ${formatNumber(radius * radius)}`,
          textNumeric: `r² = ${formatNumber(Math.round(area * 10) / 10)} ÷ 3.142592 = ${formatNumber(radius * radius)}` },
        { type: 'step', text: `r = √${formatNumber(radius * radius)} = ${formatNumber(radius)} cm` },
        { type: 'final', answer: `${formatNumber(radius)} cm` }
      ] : [
        { type: 'step', text: `Area (A) = ${answerInPi ? `${formatNumber(areaPi)}π` : formatNumber(Math.round(area * 10) / 10)} cm²` },
        { type: 'step', text: 'Area = πr²' },
        ...
        { type: 'step', textPi: `r² = ${formatNumber(radius * radius)}`,
          textNumeric: `r² = ${formatNumber(Math.round(area * 10) / 10)} ÷ 3.142592 = ${formatNumber(radius * radius)}` },
        { type: 'step', text: `r = √${formatNumber(radius * radius)} = ${formatNumber(radius)} cm` },
        { type: 'step', text: `Diameter (d) = 2r = 2 × ${formatNumber(radius)} = ${formatNumber(diameter)} cm` },
        { type: 'final', answer: `${formatNumber(diameter)} cm` }
      ];
  ...
  const generateSectorQuestion = (level: string, angle: number): QuestionType => {
    ...
    if (level === 'level1') {
      ...
      if (questionStyle === 'area') {
        ...
        working = [
          { type: 'step', text: `Diameter (d) = ${formatNumber(diameter)} cm, θ = 180°` },
          { type: 'step', text: `Radius (r) = d ÷ 2 = ${formatNumber(diameter)} ÷ 2 = ${formatNumber(radius)} cm` },
          { type: 'step', text: 'Area of sector = (θ/360) × πr²' },
          { type: 'step', text: `Area = (180/360) × π × ${formatNumber(radius)}²` },
          { type: 'step', text: `Area = (1/2) × π × ${formatNumber(radius * radius)}` },
          { type: 'step', textPi: `Area = ${formatNumber(areaPi)}π cm²`,
        ...
        working = [
          { type: 'step', text: `Diameter (d) = ${formatNumber(diameter)} cm, θ = 180°` },
          { type: 'step', text: `Radius (r) = d ÷ 2 = ${formatNumber(diameter)} ÷ 2 = ${formatNumber(radius)} cm` },
          { type: 'step', text: 'Arc length = (θ/360) × 2πr' },
          { type: 'step', text: `Arc length = (180/360) × 2 × π × ${formatNumber(radius)}` },
          { type: 'step', text: `Arc length = (1/2) × 2 × π × ${formatNumber(radius)}` },
          { type: 'step', textPi: `Arc length = ${formatNumber(arcLengthPi)}π cm`,
        ...
        working = [
          { type: 'step', text: `Diameter (d) = ${formatNumber(diameter)} cm, θ = 180°` },
          { type: 'step', text: `Radius (r) = d ÷ 2 = ${formatNumber(diameter)} ÷ 2 = ${formatNumber(radius)} cm` },
          { type: 'step', text: 'Perimeter = arc length + diameter = (θ/360) × 2πr + d' },
          { type: 'step', text: `Perimeter = (180/360) × 2 × π × ${formatNumber(radius)} + ${formatNumber(diameter)}` },
          { type: 'step', text: `Perimeter = π × ${formatNumber(radius)} + ${formatNumber(diameter)}` },
          { type: 'step', textPi: `Perimeter = ${answerPi} cm`,
      ...
      if (questionStyle === 'area') {
        ...
        answer = answerInPi ? answerPi : answerNumeric;
        working = [
          { type: 'step', text: `Diameter (d) = ${formatNumber(diameter)} cm, θ = 90°` },
          { type: 'step', text: `Radius (r) = d ÷ 2 = ${formatNumber(diameter)} ÷ 2 = ${formatNumber(radius)} cm` },
          { type: 'step', text: 'Area of sector = (θ/360) × πr²' },
          { type: 'step', text: `Area = (90/360) × π × ${formatNumber(radius)}²` },
          { type: 'step', text: `Area = (1/4) × π × ${formatNumber(radius * radius)}` },
          { type: 'step', textPi: `Area = ${formatNumber(areaPi)}π cm²`,
        ...
        working = [
          ...
          { type: 'step', text: `Radius (r) = d ÷ 2 = ${formatNumber(diameter)} ÷ 2 = ${formatNumber(radius)} cm` },
          { type: 'step', text: 'Arc length = (θ/360) × 2πr' },
          { type: 'step', text: `Arc length = (90/360) × 2 × π × ${formatNumber(radius)}` },
          { type: 'step', text: `Arc length = (1/4) × 2 × π × ${formatNumber(radius)}` },
          { type: 'step', textPi: `Arc length = ${formatNumber(arcLengthPi)}π cm`,
        ...
        working = [
          { type: 'step', text: `Diameter (d) = ${formatNumber(diameter)} cm, θ = 90°` },
          { type: 'step', text: `Radius (r) = d ÷ 2 = ${formatNumber(diameter)} ÷ 2 = ${formatNumber(radius)} cm` },
          { type: 'step', text: 'Perimeter = arc length + 2r = (θ/360) × 2πr + 2r' },
          { type: 'step', text: `Perimeter = (90/360) × 2 × π × ${formatNumber(radius)} + 2 × ${formatNumber(radius)}` },
          { type: 'step', text: `Perimeter = 0.5 × π × ${formatNumber(radius)} + ${formatNumber(2 * radius)}` },
          { type: 'step', textPi: `Perimeter = ${answerPi} cm`,
      ...
      if (questionStyle === 'area') {
        ...
        answer = answerInPi ? answerPi : answerNumeric;
        working = [
          { type: 'step', text: `Diameter (d) = ${formatNumber(diameter)} cm, θ = ${theta}°` },
          { type: 'step', text: `Radius (r) = d ÷ 2 = ${formatNumber(diameter)} ÷ 2 = ${formatNumber(radius)} cm` },
          { type: 'step', text: 'Area of sector = (θ/360) × πr²' },
          { type: 'step', text: `Area = (${theta}/360) × π × ${formatNumber(radius)}²` },
          { type: 'step', text: `Area = (${theta}/360) × π × ${formatNumber(radius * radius)}` },
          { type: 'step', textPi: `Area = ${answerPi} cm²`,
        ...
        working = [
          ...
          { type: 'step', text: `Radius (r) = d ÷ 2 = ${formatNumber(diameter)} ÷ 2 = ${formatNumber(radius)} cm` },
          { type: 'step', text: 'Arc length = (θ/360) × 2πr' },
          { type: 'step', text: `Arc length = (${theta}/360) × 2 × π × ${formatNumber(radius)}` },
          { type: 'step', text: `Arc length = (${theta}/360) × ${formatNumber(2 * radius)} × π` },
          { type: 'step', textPi: `Arc length = ${answerPi} cm`,
        ...
        working = [
          ...
          { type: 'step', text: `Radius (r) = d ÷ 2 = ${formatNumber(diameter)} ÷ 2 = ${formatNumber(radius)} cm` },
          { type: 'step', text: 'Perimeter = arc length + 2r = (θ/360) × 2πr + 2r' },
          { type: 'step', text: `Perimeter = (${theta}/360) × 2 × π × ${formatNumber(radius)} + 2 × ${formatNumber(radius)}` },
          { type: 'step', text: `Perimeter = (${theta}/360) × ${formatNumber(2 * radius)} × π + ${formatNumber(2 * radius)}` },
          { type: 'step', textPi: `Perimeter = ${answerPi} cm`,
            textNumeric: `Perimeter = ${formatNumber(Math.round(arcLength * 10) / 10)} + ${formatNumber(2 * radius)} = ${answerNumeric} cm` },
          { type: 'final', answerPi: `${answerPi} cm`, answerNumeric: `${answerNumeric} cm` }
        ];
            ...
            {['circumference', 'area', 'sectors'].map((topic: string) => (
              <button key={topic} onClick={() => setQuestionType(topic)}
                className={'px-8 py-4 rounded-xl font-bold text-xl transition-all shadow-xl ' +
                  (questionType === topic ? 'bg-blue-900 text-white' : 'bg-white text-gray-800 hover:bg-gray-100 hover:text-blue-900')}>
              ...
              {whiteboardQuestion && (
                <div className="rounded-xl shadow-2xl p-8" style={{ backgroundColor: getQuestionBg() }}>
                  ...
                  <div className="flex gap-6">
                    ...
                    <div className="flex-1 rounded-xl p-6" style={{ minHeight: '500px', backgroundColor: getWhiteboardWorkingBg() }}></div>
                  </div>
                </div>
              )}
            </>
                        ...
                        <div className="space-y-4 mt-8">
                          {question.working?.filter((step: WorkingStep) => step.type !== 'final').map((step: WorkingStep, idx: number) => (
                            <div key={idx} className="rounded-xl p-6" style={{ backgroundColor: getStepBg() }}>
                              <h4 className="text-xl font-bold mb-2" style={{ color: '#000000' }}>Step {idx + 1}</h4>
                  ...
                  <div className="flex justify-center items-center gap-6">
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" checked={allowDecimals}
                          onChange={(e) => setAllowDecimals(e.target.checked)} className="w-4 h-4" />
                        <span className="text-base font-semibold" style={{ color: '#000000' }}>Decimals</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" checked={answerInPi}
                          onChange={(e) => setAnswerInPi(e.target.checked)} className="w-4 h-4" />
                        <span className="text-base font-semibold" style={{ color: '#000000' }}>In π</span>
                      </label>
                    </div>
                    ...
                    {questionType === 'sectors' && (
                      <select value={sectorQuestionStyle}
                        onChange={(e) => setSectorQuestionStyle(e.target.value)}
                        className="px-4 py-2 border-2 border-gray-300 rounded-lg text-base font-semibold bg-white">
                        <option value="mixed">Mixed</option>
                        <option value="area">Area</option>
                        <option value="arcLength">Arc Length</option>
                        <option value="perimeter">Perimeter</option>
