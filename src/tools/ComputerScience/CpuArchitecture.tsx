...
import {
  Home, Menu, X, ChevronLeft, ChevronRight, RefreshCw,
  BookOpen, Layers, CheckSquare, PenLine, FileText, Info, GraduationCap, Check,
} from "lucide-react";
import {
  NAVY, CARD_SHADOW, TAB_SHADOW, useIsMobile, boldText,
  BeyondBadge, SegRow, registerTooltip, showTooltip, TooltipOverlay,
  TopicProvider, SpecBadge,
  LearnMode, FlashcardMode, StudyMode, QuizMode, SpotMistakeMode, FillInMode,
