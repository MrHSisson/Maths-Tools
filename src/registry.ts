...
export const CATEGORIES: CategoryMeta[] = [
  ...
  },
  {
    ...
    subject: 'Computer Science',
    tools: [
      { id: 'binary-addition', path: '/binary-addition', name: 'Binary Addition & Shifts', description: 'Add 8-bit binary integers and perform binary shifts, identifying overflow and underflow, following the OCR J277 approach', load: () => import('./tools/Binary/BinaryAddition') },
