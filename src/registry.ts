...
export const CATEGORIES: CategoryMeta[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'iterations', path: '/iterations', name: 'Iteration', description: 'Find roots to equations using iterative methods', ready: 'v2.3', load: () => import('./tools/Algebra/Iterations') },
      { id: 'simultaneous-equations-elimination', path: '/simultaneous-equations-elimination', name: 'Simultaneous Equations (Elimination)', description: 'Solve simultaneous equations, including rearranging', ready: 'v2.3', load: () => import('./tools/Algebra/SimultaneousEquations') },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'bearings', path: '/bearings', name: 'Bearings', description: 'Identify bearings from diagrams with North lines - two-point and three-point routes', ready: 'v2.3', load: () => import('./tools/Geometry/Bearings') },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'skill-library', path: '/skills', name: 'Skill Library', description: 'Browse every core skill taught through short slide sequences — the drill-downs linked from worked-example steps', ready: 'v2.4', enabled: false, load: () => import('./tools/TeacherTools/SkillLibrary') },
    ],
  },
  {
